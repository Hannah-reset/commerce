...
CREATE TABLE `t_address` (
  ...
  `uid` int(11) NOT NULL COMMENT '归属的用户ID',
  `recv_name` varchar(50) NOT NULL COMMENT '收货人',
  `recv_province` varchar(6) NOT NULL COMMENT '省代号',
  `recv_city` varchar(6) NOT NULL COMMENT '市代号',
  `recv_area` varchar(6) NOT NULL COMMENT '区代号',
  `recv_district` varchar(32) NOT NULL COMMENT '省市区的名称',
  `recv_addr` varchar(50) NOT NULL COMMENT '详细地址',
  `recv_phone` varchar(32) NOT NULL COMMENT '手机号码',
  `recv_tel` varchar(32) DEFAULT NULL COMMENT '固定电话',
  `recv_zip` varchar(6) DEFAULT NULL COMMENT '邮政编码',
  `recv_tag` varchar(6) DEFAULT NULL COMMENT '地址名称',
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES ('4', 'hjq2', '123456', null, null, null, null, null, null, null);
INSERT INTO `t_user` VALUES ('99', 'zhangsan', '12345', '18232567515', '8888@qq.com', '0', null, null, null, null);
INSERT INTO `t_user` VALUES ('998', 'lxy12', '1234569', null, null, null, null, null, null, null);
INSERT INTO `t_user` VALUES ('999', 'lxy123', '8b394b2718399c8a7d523017ac13575f', '18311247233', '123@qq.com', null, null, null, null, null);
INSERT INTO `t_user` VALUES ('1000', 'tomcat', 'passWord', null, null, null, null, null, null, null);
INSERT INTO `t_user` VALUES ('1004', 'tomcat8', 'passWord', null, null, null, null, null, null, null);
INSERT INTO `t_user` VALUES ('1005', 'tomcat9', 'passWord', null, null, null, null, null, null, null);
